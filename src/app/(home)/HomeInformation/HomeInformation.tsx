      ...
      <section className="py-12 px-4 md:px-6 lg:px-8 mx-auto max-w-7xl">
        ...
        <div className="flex flex-col gap-[41px] mt-[36px]">
          ...
          <InformationCard
            ...
            title="Web3"
            text="踏入去中心化時代，利用區塊鏈技術打造更透明、安全且自主的應用。從&nbsp;NFT&nbsp;到去中心化金融&ensp;(DeFi)，挑戰傳統經濟與技術，創造全新的數位價值與商業模式！(待改)"
          />
          ...
          <InformationCard
            className="justify-start"
            title="DevOps"
            text="加速軟體開發與部署流程，提升效能與穩定性。透過&ensp;CI/CD、基礎設施即碼化&nbsp;(IaC)、容器技術等實踐優化流程，推動敏捷運作與高品質交付！(待改)"
          />
        </div>
        ...
        <div className="flex flex-col mt-[36px]">
          <EventDescription
            title="第一階段 - 個人篩選："
            text="每個領域會由兩位（暫定）具該領域專業之教授進行評分與篩選，根據結果會產生進入複賽的人選，AI、Web3、DevOps 各領域會有相應的人數限制，總共100人。(待改)"
            keyword="相應的人數限制"
          />
          <EventDescription
            title="第二階段 - 前置工作坊："
            text="進入複賽的100人會由主辦團隊據其報名領域合理分配至20個組別中，並於5/24舉辦前置工作坊，使各組別先行熟悉彼此，同時學習相關技術知識。"
          />
          <EventDescription
            title="第三階段 - 黑克松競賽（正賽）："
